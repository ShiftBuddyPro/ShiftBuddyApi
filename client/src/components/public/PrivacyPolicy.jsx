      ...
      <div style={{ padding: 40 }}>
        ...
        <p>
          ...
          <a style={{ color: "blue" }} href="https://www.shiftbuddypro.com">
            https://www.shiftbuddypro.com
          </a>{" "}
          (hereinafter, "us", "we", or "https://www.shiftbuddypro.com") as well
          as the mobile application ShiftBuddyPro. We respect your privacy and
        ...
        <p>
          Like most website operators, ShiftBuddyPro collects
          non-personally-identifying information of the sort that web browsers
          and servers typically make available, such as the browser type,
          language preference, referring site, and the date and time of each
          visitor request. ShiftBuddyPro's purpose in collecting non-personally
          identifying information is to better understand how ShiftBuddyPro's
          visitors use its website. From time to time, ShiftBuddyPro may release
          non-personally-identifying information in the aggregate, e.g., by
          publishing a report on trends in the usage of its website.
        </p>
        <p>
          ShiftBuddyPro also collects potentially personally-identifying
          information like Internet Protocol (IP) addresses for logged in users
          and for users leaving comments on https://www.shiftbuddypro.com blog
          posts. ShiftBuddyPro only discloses logged in user and commenter IP
          addresses under the same circumstances that it uses and discloses
          personally-identifying information as described below.
        </p>
        <h2>Gathering of Personally-Identifying Information</h2>
        <p>
          Certain visitors to ShiftBuddyPro's websites choose to interact with
          ShiftBuddyPro in ways that require ShiftBuddyPro to gather
          personally-identifying information. The amount and type of information
          that ShiftBuddyPro gathers depends on the nature of the interaction.
          For example, we ask visitors who sign up for a blog at
          https://www.shiftbuddypro.com to provide a username and email address.
        </p>
        <h2>Security</h2>
        <p>
        ...
        <p>
          ...
          ShiftBuddyPro and does not cover the use of cookies by any
          advertisers.
        </p>
        ...
        <p>
          ...
          information in order to process it on ShiftBuddyPro's behalf or to
          provide services available at ShiftBuddyPro's website, and (ii) that
          ...
          your home country; by using ShiftBuddyPro's website, you consent to
          the transfer of such information to them. ShiftBuddyPro will not rent
          ...
          affiliated organizations, as described above, ShiftBuddyPro discloses
          ...
          governmental request, or when ShiftBuddyPro believes in good faith
          that disclosure is reasonably necessary to protect the property or
          rights of ShiftBuddyPro, third parties or the public at large.
        </p>
        <p>
          If you are a registered user of https://www.shiftbuddypro.com and have
          supplied your email address, ShiftBuddyPro may occasionally send you
          an email to tell you about new features, solicit your feedback, or
          just keep you up to date with what's going on with ShiftBuddyPro and
          our products. We primarily use our blog to communicate this type of
          ...
          other users. ShiftBuddyPro takes all measures reasonably necessary to
        ...
        <p>
          ShiftBuddyPro may collect statistics about the behavior of visitors to
          its website. ShiftBuddyPro may display this information publicly or
        ...
        <p>
          ...
          ShiftBuddyPro's services or products, are asked to provide additional
          ...
          ShiftBuddyPro collects such information only insofar as is necessary
          or appropriate to fulfill the purpose of the visitor's interaction
          with ShiftBuddyPro. ShiftBuddyPro does not disclose
        ...
        <p>
          If ShiftBuddyPro, or substantially all of its assets, were acquired,
          or in the unlikely event that ShiftBuddyPro goes out of business or
          enters bankruptcy, user information would be one of the assets that is
          transferred or acquired by a third party. You acknowledge that such
          transfers may occur, and that any acquirer of ShiftBuddyPro may
          continue to use your personal information as set forth in this policy.
        </p>
        <h2>Privacy Policy Changes</h2>
        <p>
          Although most changes are likely to be minor, ShiftBuddyPro may change
          its Privacy Policy from time to time, and in ShiftBuddyPro's sole
          discretion. ShiftBuddyPro encourages visitors to frequently check this
        ...
        <p>
          ...
          us via{" "}
          <a style={{ color: "blue" }} href="mailto:usman@shiftbuddypro.com">
            email
          </a>{" "}
          or <a href="tel:2053701266">phone</a>.
        </p>
      </div>
    </div>
  );
