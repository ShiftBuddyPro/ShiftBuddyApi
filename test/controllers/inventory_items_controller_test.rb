...
class InventoryItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory_item" do
    assert_difference('InventoryItem.count') do
      post inventory_items_url, params: { inventory_item: { end_amount: @inventory_item.end_amount, name: @inventory_item.name, start_amount: @inventory_item.start_amount } }, as: :json
    end
  ...
  test "should update inventory_item" do
    patch inventory_item_url(@inventory_item), params: { inventory_item: { end_amount: @inventory_item.end_amount, name: @inventory_item.name, start_amount: @inventory_item.start_amount } }, as: :json
    assert_response 200
  end
