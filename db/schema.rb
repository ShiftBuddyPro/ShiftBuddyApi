...
ActiveRecord::Schema.define(version: 20_190_608_080_541) do
  ...
  create_table 'businesses', force: :cascade do |t|
    ...
    t.index %w[manager_id], name: 'index_businesses_on_manager_id'
  end
  ...
  create_table 'cash_drops', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[shift_id], name: 'index_cash_drops_on_shift_id'
  end
  ...
  create_table 'change_sheets', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[shift_id], name: 'index_change_sheets_on_shift_id'
  end
  ...
  create_table 'checks', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[shift_id], name: 'index_checks_on_shift_id'
  end
  ...
  create_table 'employees', force: :cascade do |t|
    ...
    t.string 'username'
    t.integer 'status'
    t.index %w[manager_id], name: 'index_employees_on_manager_id'
  end
  ...
  create_table 'inventory_items', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[shift_id], name: 'index_inventory_items_on_shift_id'
  end
  ...
  create_table 'notes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[shift_id], name: 'index_notes_on_shift_id'
  end
  ...
  create_table 'paid_outs', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[shift_id], name: 'index_paid_outs_on_shift_id'
  end
  ...
  create_table 'shifts', force: :cascade do |t|
    ...
    t.index %w[employee_id], name: 'index_shifts_on_employee_id'
  end
  ...
  create_table 'tracked_items', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[manager_id], name: 'index_tracked_items_on_manager_id'
  end
